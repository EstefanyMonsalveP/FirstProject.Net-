<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FrmSentido.aspx.cs" Inherits="primeraEntrega.FrmSentido" %>
			...
			<div class="table-responsive">
				<div class="table-wrapper">
					<div class="table-title">
						<div class="row">
							<div class="col-sm-6">
								<h2 class="miEstilo">Gestion <b>Sentido</b></h2>
							</div>
							<div class="col-sm-6">
								<a href="#crudModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Gestión Sentido</span></a>						
							</div>
						</div>
					</div>
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><% Response.Write(arregloSentido[i].Nombre); %></td>
								<td>
			...
			<div class="modal-dialog">
				<div class="modal-content">
						<div class="modal-header">						
							<h4 class="modal-title">Gestion Sentido</h4>
						...
						<div class="modal-body">					
							...
							<div class="form-group">
								<label>Nombre</label>
								<asp:TextBox ID="txtNombre3" runat="server"  class="form-control"></asp:TextBox>
							</div>
							<div class="form-group">
