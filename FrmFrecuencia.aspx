<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FrmFrecuencia.aspx.cs" Inherits="primeraEntrega.FrmFrecuencia" %>
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 class="miEstilo"> <b>Frecuencia</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Gestión Frecuencia</span></a>						
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><% Response.Write(arregloFrecuencia[i].Id); %></td>
						<td><% Response.Write(arregloFrecuencia[i].Descripcion); %></td>
						<td>
