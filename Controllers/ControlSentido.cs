...
namespace primeraEntrega.Controllers
{
    public class ControlSentido
    {
        ...
        public Sentido[] Listar()
        {
            ...
            string comandoSQL = "SELECT * FROM sentido";
            string msg = "ok";
            int i;
            ...
            try
            {
                if (objDataSet.Tables[0].Rows.Count > 0)
                {
                    ...
                    while (i < objDataSet.Tables[0].Rows.Count)
                    {
                        ...
                        objSentido.Id = Convert.ToInt32(objDataSet.Tables[0].Rows[i][0].ToString());
        ...
        public Sentido Consultar()
        {
            ...
            string comandoSql = String.Format("SELECT *FROM sentido WHERE ID ={0}", id);
            string msj = "Ok";
            ...
            try
            {
                ...
                if (objDataSet.Tables[0].Rows.Count > 0)
                {
                    ...
                    objSentido.Id = Convert.ToInt32(objDataSet.Tables[0].Rows[0][0]);
        ...
        public string Guardar()
        {
            ...
            string comandoSql = String.Format("INSERT INTO sentido ( NOMBRE) VALUES ('{0}')", nombre);
            string msj = "Ok";
        ...
        public string Modificar()
        {
            ...
            int id = objSentido.Id;
            string nombre = objSentido.Nombre;
            string comandoSql = String.Format("UPDATE sentido SET NOMBRE ='{0}' WHERE ID= '{1}'", nombre, id);
            string msj = "Ok";
        ...
        public string Borrar()
        {
            ...
            ControlConexion objControlConexion = new ControlConexion(baseDeDatos);
            int id = objSentido.Id;
            string comandoSQL = String.Format("DELETE FROM sentido WHERE id='{0}'", id);
            string msg = "ok";
